...
if(isset($_POST['submit'])){
   ...
   $address = $_POST['flat'] .', '.$_POST['building'].', '.$_POST['area'];
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Update your college details</h3>
      <input type="text" class="box" placeholder="Your College name" required maxlength="50" name="flat">
      <input type="text" class="box" placeholder="Your Department name" required maxlength="50" name="building">
      <input type="text" class="box" placeholder="Current Year" required maxlength="50" name="area">
