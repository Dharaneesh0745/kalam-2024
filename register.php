...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_user = $conn->prepare("INSERT INTO `users`(name, kalam_id, email, number, password) VALUES(?,?,?,?,?)");
         $insert_user->execute([$name, $kalam_id, $email, $number, $cpass]);
